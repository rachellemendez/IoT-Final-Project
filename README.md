...
* **[Lab 01: Sequential LED Control](https://github.com/rachellemendez/IoT-Final-Project/tree/main/IoT_Lab_Activities/Lab01_SequentialLEDs)**
...
* **[Lab 02: Analog Sequential Control](https://github.com/rachellemendez/IoT-Final-Project/tree/main/IoT_Lab_Activities/Lab02_AnalogSequential)**
...
* **[Lab 03: Fire Sensor System](https://github.com/rachellemendez/IoT-Final-Project/tree/main/IoT_Lab_Activities/Lab03_FireSensor)**
...
* **[Lab 04: Arduino Serial Control System](https://github.com/rachellemendez/IoT-Final-Project/tree/main/IoT_Lab_Activities/Lab04_ArduinoSerialConn)**
...
* **[Lab 05: Receiving Serial Connection using Arduino from Python](https://github.com/rachellemendez/IoT-Final-Project/tree/main/IoT_Lab_Activities/Lab05_PythonArduinoSerialReceive)**
...
* **[Lab 06: Bidirectional Control using Arduino and Python](https://github.com/rachellemendez/IoT-Final-Project/tree/main/IoT_Lab_Activities/Lab06_PythonArduinoBidirectional)**
...
* **[Lab 07: Controlling Arduino using FastAPI](https://github.com/rachellemendez/IoT-Final-Project/tree/main/IoT_Lab_Activities/Lab07_FastAPIArduinoControl)**
...
* **[Midterm Laboratory Exam: Serial Controlled Light Sensor System](https://github.com/rachellemendez/IoT-Final-Project/tree/main/IoT_Lab_Exams/IoT_Lab_Midterms_SerialLightSensor)**
    * *Project Overview:* This project implements a **Dual-Mode Light Sensor System** using an Arduino Uno. It monitors ambient light intensity via a photoresistor (LDR) and provides visual feedback using a "Traffic Light" LED configuration (Green, Yellow, Red). The system features two distinct operating modes:
        * **Automatic Mode:** The system autonomously classifies the environment into "Cloudy," "Normal," or "Bright Sunlight" states using hardcoded thresholds (40% and 70%).
        * **Manual Mode:** The user gains full control via the Serial Monitor to dynamically set custom threshold values (`SET LOW` and `SET HIGH`), allowing for real-time calibration to specific environments without re-uploading code.

* **[Finals Laboratory Exam: IoT Button Client](https://github.com/rachellemendez/IoT-Final-Project/tree/main/IoT_Lab_Exams/IoT_Lab_Finals_IoTWebBridge)**
